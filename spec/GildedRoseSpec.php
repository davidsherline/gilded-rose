...
describe('Gilded Rose', function () {
    ...
    describe('#tick', function () {
        ...
        context ("Conjured Items", function () {
            ...
            xit ('updates Conjured items before the sell date', function () {
            ...
            xit ('updates Conjured items at zero quality', function () {
            ...
            xit ('updates Conjured items on the sell date', function () {
            ...
            xit ('updates Conjured items on the sell date at 0 quality', function () {
            ...
            xit ('updates Conjured items after the sell date', function () {
                $item = GildedRose::of('Conjured Mana Cake', 10, -10);
            ...
            xit ('updates Conjured items after the sell date at zero quality', function () {
                $item = GildedRose::of('Conjured Mana Cake', 0, -10);
